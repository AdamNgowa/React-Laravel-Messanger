...
import UsersOptionsDropdown from "@/Components/App/UserOptionsDropdown";
    ...
    return (
        ...
        >
            {conversation.is_user && (
                <UserAvatar user={conversation} online={online}></UserAvatar>
            )}
            ...
            {currentUser.is_admin && conversation.is_user && (
                <UsersOptionsDropdown conversation={conversation} />
            )}
        </Link>
    );
};
